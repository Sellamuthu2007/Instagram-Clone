    ...
    return (
        <>
             <div className='side-left'>
                ...
                <div
                onClick = {()=> {navigate('/story/1/15')}}><i className="bi bi-camera-reels" id="side-logo"></i><span>Reels</span></div>
                ...
                <div><i className="bi bi-person" id="side-logo" 
                onClick={()=>navigate('/myprofile')}
                ></i><span>Profile</span></div>
            </div>
            <div className='sidebar'>
